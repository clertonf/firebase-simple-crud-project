...
export function UpdateStudent() {
  ...
  const [student, setStudent] = useState<FormDataProps>({} as FormDataProps);
  ...
  useEffect(() => {
    if (id) {
      firestore()
        ...
        .get()
        .then((response) => {
          const student = response.data() as FormDataProps;
          setStudent(student);
        });
    }
  }, [id]);

  function handleUpdateUser({ name, course, ira }: FormDataProps) {
    setLoading(true);
    firestore()
      .collection('student')
      .doc(id)
